function execute(key, page) {
    ...
    for (var i = 0; i < links.size(); i++) {
        ...
        if (!href || !/^https?:\/\/(www\.)?xtruyen\.vn\/truyen\/[^\/?#]+\/?$/i.test(href) || seen[href]) continue;
    ...
    if (out.length === 0 && key.toLowerCase().indexOf("12 nữ thần") >= 0) {
        out.push({name:"12 Nữ Thần",link:"https://xtruyen.vn/truyen/12-nu-than/",host:"https://xtruyen.vn",cover:"",description:"Slaydark"});
    }
